...
```{r study2b vertical horizontal individualism w/o excl, echo=FALSE, fig.cap="Personal level individualism/collectivism effects on moral acceptibility ratings (speedboat dilemmas)", message=FALSE, warning=FALSE, out.width="80%", paged.print=FALSE}
graphdata <-
  tabledata_sb_ind_f_tidy %>%
  filter(variable != "Country-level collectivism") %>%
  select(variable, b, lower, higher)
