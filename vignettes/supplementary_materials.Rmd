...
demo_table <-
  ...
  gt::tab_header(title = "Table S1. Demographic description of the sample by country.")%>%
...
table<-bind_rows(additional_trolley, additional_speedboat) %>% 
  ...
  kbl(
    caption = "Table S2. Effect of Physical Contact and Intention (all exclusion applied)",
    escape = TRUE,
    format = "latex",
    booktabs = T,
    position= "H") %>%
  ...
  collapse_rows(columns = 2, valign = "top", latex_hline="none" )
...
bind_rows(additional_trolley, additional_speedboat) %>% 
  ...
  transmute(Dilemma = str_to_title(Dilemma),
            ...
            p = if_else(as.numeric(p) < .001, "< .001", p)) %>% 
 kbl(
    caption = "Table S3. Effect of Physical Contact and Intention on moral dilemma judgements (familiarity exclusion not applied).",
    escape = TRUE,
    format = "latex",
    booktabs = T,
    position= "H") %>%
...
bind_rows(additional_trolley, additional_speedboat) %>% 
  ...
  transmute(Dilemma = str_to_title(Dilemma),
            ...
            p = if_else(as.numeric(p) < .001, "< .001", p)) %>% 
  kbl(
    caption = "Table S4. Comparing the Standard Switch and Standard Footbridge Dilemmas (all exclusion applied).",
    escape = TRUE,
    format = "latex",
    booktabs = T,
    position= "H") %>%
...
bind_rows(additional_trolley, additional_speedboat) %>% 
  ...
  transmute(Dilemma = str_to_title(Dilemma),
            ...
            p = if_else(as.numeric(p) < .001, "< .001", p)) %>% 
  kbl(
    caption = "Table S5. Comparing the Standard Switch and Standard Footbridge Dilemmas (familiarity exclusion not applied)",
    escape = TRUE,
    format = "latex",
    booktabs = T,
    position= "H") %>%
...
kbl(
  ...
  booktabs = T,
  escape = T,
  caption = "Table S6. The effect of personal force on moral dilemma judgements (familiar participants).",
  centering = T,
  position = "H") %>%
  kable_styling(full_width = F,  position = "left") %>%
  row_spec(row = 0, bold = TRUE) %>%
...
kbl(
  ...
  booktabs = T,
  escape = F,
  caption = "Table S7. The interaction of personal force and intention on moral dilemma judgemnts (familiar participants).",
  centering = T,
  position = "H") %>%
  kable_styling(full_width = F,  position = "left") %>%
  row_spec(row = 0, bold = TRUE) %>%
...
kbl(
  ...
  booktabs = TRUE,
  escape = TRUE,
  caption = "Table S8. Is the interaction of personal force and intention affected by individualism/collectivism on Trolley dilemmas?",
  centering = TRUE,
  position = "H") %>%
...
kbl(
  ...
  booktabs = TRUE,
  escape = TRUE,
  caption = "Table S9. Is the interaction of personal force and intention affected by individualism/collectivism on Speedboat dilemmas?",
  centering = TRUE,
  position = "H") %>%
  kable_styling(full_width = FALSE,  position = "left") %>%
  row_spec(row = 0, bold = TRUE) %>%
