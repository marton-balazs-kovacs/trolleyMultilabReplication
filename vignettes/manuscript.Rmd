...
fig11 <-
  fig11_left + 
    labs(subtitle = "A Trolley dilemmas - no exclusion criteria applied") +
  fig11_right + 
    labs(subtitle = "B Speedboat dilemmas - no exclusion criteria applied") +
...
fig12 <-
  fig12_left + 
    labs(subtitle = "A Trolley dilemma - no exclusion criteria applied") +
  fig12_right +
    labs(subtitle = "B Speedboat dilemma - no exclusion criteria applied") +
   plot_layout(ncol = 2)
