...
kbl(
  studys1a_results,
  format = "latex",
  col.names = c("Exclusion", "Cluster", "BF", "RR", "t", "df", "p", "Cohen's d", "$89\\%$ CI"),
  booktabs = T,
  escape = F,
...
kbl(
  full_table_trolley,
  format = "latex",
  col.names = c("Variable", "BF", "b", "p", "$89\\%$ CI", "BF", "b", "p", "$89\\%$ CI"),
  booktabs = TRUE,
  escape = F,
...
kbl(
  studys1a_results,
  col.names = c("Dilemma", "Cluster", "BF", "t", "df", "p", "Cohen's d", "$89\\%$ CI"),
  format = "latex",
  booktabs = T,
  escape = T,
...
```{r study2a overall individualism plot ne, fig.pos = "H", out.width = "80%", fig.cap = "Correlation between country-level individualism/collectivism and the effect of personal force in Eta sqaured on the Trolley dilemmas (no exclusion)", echo = FALSE, message=FALSE, warning = FALSE, paged.print = FALSE}
# Prepare data for plotting
