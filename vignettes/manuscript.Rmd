...
# Save plot
ggplot2::ggsave("vignettes/figures/fig9.pdf", device = "pdf", plot = ggplot2::last_plot(), dpi = 300)
```
...
# Save plot
ggplot2::ggsave("vignettes/figures/fig10.pdf", device = "pdf", plot = ggplot2::last_plot(), dpi = 300)
```
