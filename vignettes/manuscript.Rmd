...
fig1_tags <-
  tibble(x = rep(.55, 3),
         y = rep(8.55, 3),
         survey_name = unique(plot_data$survey_name),
         label = LETTERS[1:3],
         )
...
ggplot2::ggsave(plot = fig1, 
                filename = "vignettes/figures/fig1.pdf", 
                device = "pdf", 
                dpi = 300)
```
...
# Save plot
ggplot2::ggsave(plot = fig2, filename = "vignettes/figures/fig2.pdf", device = "pdf", dpi = 300)
```
...
fig1_2 <-
  fig1 + 
  fig2 + 
  plot_layout(ncol = 1, tag_level = "new")

ggsave(plot = fig1_2, 
       filename = "vignettes/figures/fig1_2.pdf", 
       device = "pdf", dpi = 300, scale = 2)
...
ggplot2::ggsave(plot = fig3, 
                filename = "vignettes/figures/fig3.pdf", 
                device = "pdf", 
                dpi = 300)
...
fig4 <-
  ...
  geom_text(y = -.05, 
    ...
    # Save plot
ggplot2::ggsave(plot = fig4, 
                filename = "vignettes/figures/fig4.pdf", 
                device = "pdf", 
                dpi = 300)
```
...
# Save plot
ggplot2::ggsave("vignettes/figures/fig5.pdf", device = "pdf", plot = ggplot2::last_plot(), dpi = 300)
```
...
# Save plot
ggplot2::ggsave("vignettes/figures/fig6.pdf", device = "pdf", plot = ggplot2::last_plot(), dpi = 300)
```
...
# Save plot
ggplot2::ggsave("vignettes/figures/fig7.pdf", device = "pdf", plot = ggplot2::last_plot(), dpi = 300)
```
#Fig 4 right
...
# Save plot
ggplot2::ggsave("vignettes/figures/fig8.pdf", device = "pdf", plot = ggplot2::last_plot(), dpi = 300)
```
...
# Create plot
fig9 <- create_plot_country(plot_data_country)

# Save plot
ggplot2::ggsave("vignettes/figures/fig9.pdf", device = "pdf", plot = fig9, dpi = 300)
```
...
fig10 <- create_plot_ind_col(graphdata)
        

# Save plot
ggplot2::ggsave("vignettes/figures/fig10.pdf", device = "pdf", plot = fig10, dpi = 300)
```
...
fig9_10 <-
  fig10 + 
  fig9 +
  plot_layout(ncol = 2, tag_level = "new") +
...
# Save plot
ggplot2::ggsave("vignettes/figures/fig11.pdf", device = "pdf", plot = ggplot2::last_plot(), dpi = 300)
```
...
# Save plot
ggplot2::ggsave("vignettes/figures/fig12.pdf", device = "pdf", plot = ggplot2::last_plot(), dpi = 300)
```
...
# Save plot
ggplot2::ggsave("vignettes/figures/fig13.pdf", device = "pdf", plot = ggplot2::last_plot(), dpi = 300)
```
...
# Save plot
ggplot2::ggsave("vignettes/figures/fig14.pdf", device = "pdf", plot = ggplot2::last_plot(), dpi = 300)
```
...
# Save plot
ggplot2::ggsave("vignettes/figures/fig15.pdf", device = "pdf", plot = ggplot2::last_plot(), dpi = 300)
```
...
# Save plot
ggplot2::ggsave("vignettes/figures/fig16.pdf", device = "pdf", plot = ggplot2::last_plot(), dpi = 300)
```
...
# Save plot
ggplot2::ggsave("vignettes/figures/fig17.pdf", device = "pdf", plot = ggplot2::last_plot(), dpi = 300)
```
#Figure 9 right
...
# Save plot
ggplot2::ggsave("vignettes/figures/fig18.pdf", device = "pdf", plot = ggplot2::last_plot(), dpi = 300)
```
...
# Save plot
ggplot2::ggsave("vignettes/figures/fig19.pdf", device = "pdf", plot = ggplot2::last_plot(), dpi = 300)
```
...
# Save plot
ggplot2::ggsave("vignettes/figures/fig20.pdf", device = "pdf", plot = ggplot2::last_plot(), dpi = 300)
```
...
# Save plot
ggplot2::ggsave("vignettes/figures/fig21.pdf", device = "pdf", plot = ggplot2::last_plot(), dpi = 300)
```
#Figure 12 left
...
# Save plot
ggplot2::ggsave("vignettes/figures/fig22.pdf", device = "pdf", plot = ggplot2::last_plot(), dpi = 300)
```
#Figure 11 right
...
# Save plot
ggplot2::ggsave("vignettes/figures/fig23.pdf", device = "pdf", plot = ggplot2::last_plot(), dpi = 300)
```
#Figure 12 right
...
create_plot_ind_col(graphdata)
ggplot2::ggsave("vignettes/figures/fig24.pdf", device = "pdf", plot = ggplot2::last_plot(), dpi = 300)
