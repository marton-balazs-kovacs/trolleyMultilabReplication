...
fig1_2 <-
  ...
  fig2_left + 
    labs(subtitle = "C Speedboat dilemma - all exclusion criteria applied") +  
  fig2_right +
    labs(subtitle = "D Speedboat dilemma - familiarity exclusion not applied") +
  plot_layout(ncol = 2)
...
# Create plot
fig5_left <- create_plot_country(plot_data_country)
...
fig6_left <- create_plot_ind_col(graphdata)
...
# Create plot
fig7_left <- create_plot_country(plot_data_country) + xlim(0, .5)
...
fig8_left <- create_plot_ind_col(graphdata)
...
# Create plot
fig5_right <- create_plot_country(plot_data_country) + xlim(0, .5)
...
fig6_right <- create_plot_ind_col(graphdata)
...
# Create plot
fig7_right <- create_plot_country(plot_data_country) + xlim(0, .7)
...
fig8_right <- create_plot_ind_col(graphdata)

fig8_right

```

### Merged Figures 5, 6, 7, 8

```{r}
fig5 <-
  fig5_left + 
    labs(subtitle = "A Trolley dilemmas (all exclusions applied)") +
  fig5_right + 
    labs(subtitle = "B Trolley dilemmas (familiarity exclusion not applied)") +
...
fig7 <-
  fig7_left + 
    labs(subtitle = "A Speedboat dilemmas (all exclusions applied)") +
  fig7_right + 
    labs(subtitle = "B Speedboat dilemmas (familiarity exclusion not applied)") +
  plot_layout(ncol = 2, guides = "collect") & theme(legend.position = 'right')
...
fig9 <-
  ...
  fig9_right + 
    labs(subtitle = "B Speedboat dilemma - no exclusion criteria applied") +
  plot_layout(ncol = 1)
...
# Create plot
fig11_left <- 
  create_plot_country(plot_data_country) + xlim(0, .5)
