...
kbl(
  studys2a_results,
  format = "latex",
  col.names=c("Exclusion", "Cluster", "BF", "RR", "t", "df", "p", "Partial $\eta^2$", "Raw effect"),
  booktabs = T,
  escape=T,
...
kbl(
  full_table_ne,
  format = "latex",
  colnames=c("Variable", "BF", "b", "p", "BF", "b", "p"),
  booktabs = TRUE,
  escape = TRUE,
  ...
  kable_styling(full_width = FALSE,  position = "left") %>%
  row_spec(row = 0, bold = TRUE)%>%
  add_header_above(c(" "=1, "With familiarity exclusion"=2, "No familiarity exclusion"=2))
...
studys2a_results<-studys1a_results[, -4]

kbl(
  studys2a_results,
    col.names=c("Dilemma", "Cluster", "BF", "t", "df", "p", "Partial $\eta^2$"),
  format = "latex",
  booktabs = T,
  escape=T,
...
tabledata_s2a_ne_ind <-  
  trolley %>% 
  left_join(., cultural_distance, by = "country3") %>% 
  calculate_interaction_stats(study_typ="trolley")
...
kbl(
  ...
  kable_styling(full_width = FALSE,  position = "left") %>%
  row_spec(row = 0, bold = TRUE)%>%
  add_header_above(c(" "=1, "Trolley"=2, "Speedboat"=2))
```
